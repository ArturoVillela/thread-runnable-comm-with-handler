...
public class RunnableDownloadImagen implements Runnable {

    private String url = Auxiliar.getImageURL();
    private Bitmap bitmap = null;
    private final String TAG="RunnableDownloadImagen";

    CommunicationHandler commHandler;

    public RunnableDownloadImagen(CommunicationHandler commHandler) {
